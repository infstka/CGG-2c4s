...
void CPyramid::ColorDraw(CDC &dc, CMatrix& PView, CRect& RW, COLORREF color) // Рисует пирамиду, освещенную источником заданного цвета
{//функция отвечает за окрашивание боковых граней указанным градиентом, если грань видима
